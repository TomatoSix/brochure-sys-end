...
// 获取所有小册
articleRouter.get("/getBrochureAll", getArticleAll);
// 获取当前用户所有小册
articleRouter.get("/getBrochureByUserId/:id", getArticleByUserId);
// 根据小册Id获取文章信息
articleRouter.get("/getBrochureById/:id", getArticleByUserId);
